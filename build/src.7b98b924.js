...
burgerToggle.addEventListener("click", function () {
  if (window.screen.width <= 576) headerContent.classList.toggle('hide-smth');
  headerTitle.classList.toggle('hide-smth');
  headerMedia.classList.toggle('hide-smth');
});
/* ---- Toggle hamburger open/close button ---- */

var burgerToggler = document.querySelector('.navbar-toggler');
...
//# sourceMappingURL=src.7b98b924.js.map